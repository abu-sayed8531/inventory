...
<nav class="navbar sticky-top shadow-sm navbar-expand-lg navbar-light py-2">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="header01">
            ...
            <div><a class="btn mt-3 bg-gradient-primary" href="{{route('login.page')}}">Start Sale</a></div>
        </div>
    </div>
</nav>
        ...
        <div class="container pt-2">
            <div class="row align-items-center mb-5">
                <div class="col-12 col-md-10 col-lg-5 mb-5 mb-lg-0">
                    ...
                    <div class="d-flex flex-wrap"><a class="btn bg-gradient-primary me-2 mb-2 mb-sm-0" href="{{route('login.page')}}">Start Sale</a>
                        <a class="btn bg-gradient-primary mb-2 mb-sm-0" href="{{route('login.page')}}">Login</a></div>
                </div>
