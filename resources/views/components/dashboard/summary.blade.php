                ...
                <div class="p-3">
                    <div class="row">
                        <div class="col-9 col-lg-8 col-md-8 col-sm-9">
                            <div>
                                <h5 class="mb-0 text-capitalize font-weight-bold">
                                    $ <span id="todaySale"></span>
                                </h5>
                                <p class="mb-0 text-sm">Today's Sale</p>
                            </div>
                        </div>
                        <div class="col-3 col-lg-4 col-md-4 col-sm-3 text-end">
                            <div class="icon icon-shape bg-gradient-primary shadow float-end border-radius-md">
                ...
                <div class="p-3">
                    <div class="row">
                        <div class="col-9 col-lg-8 col-md-8 col-sm-9">
                            <div>
                                <h5 class="mb-0 text-capitalize font-weight-bold">
                                    $ <span id="thisMonthSale"></span>
                                </h5>
                                <p class="mb-0 text-sm">This Month's Sale</p>
                            </div>
                        </div>
                        <div class="col-3 col-lg-4 col-md-4 col-sm-3 text-end">
                            <div class="icon icon-shape bg-gradient-primary shadow float-end border-radius-md">
...
<script>
    ...
    async function getList(){
        showLoader();
        try{
            let res = await axios.post('/dashboard-list');
            hideLoader();
        ...
        document.getElementById('todaySale').innerText = data.today_sale;
        document.getElementById('thisMonthSale').innerText = data.this_month_sale;
